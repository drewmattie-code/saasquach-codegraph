"""
Fortune 200 enterprise module: it_operations/crowdstrike_security.py.
...
class CrowdStrikeSecurity:
    """CrowdStrikeSecurity orchestrates enterprise process capabilities and integrations."""
...
class EndpointTelemetry:
    """EndpointTelemetry orchestrates enterprise process capabilities and integrations."""
...
class ThreatHunting:
    """ThreatHunting orchestrates enterprise process capabilities and integrations."""
...
class ContainmentActions:
    """ContainmentActions orchestrates enterprise process capabilities and integrations."""
...
class VulnerabilityInsights:
    """VulnerabilityInsights orchestrates enterprise process capabilities and integrations."""
...
class PolicyHardening:
    """PolicyHardening orchestrates enterprise process capabilities and integrations."""
