"""
Fortune 200 enterprise module: offsystems/workday_hcm.py.
...
class WorkdayHCMClient:
    """WorkdayHCMClient orchestrates enterprise process capabilities and integrations."""
...
class WorkdayCoreHR:
    """WorkdayCoreHR orchestrates enterprise process capabilities and integrations."""
...
class WorkdayCompensation:
    """WorkdayCompensation orchestrates enterprise process capabilities and integrations."""
...
class WorkdayAbsence:
    """WorkdayAbsence orchestrates enterprise process capabilities and integrations."""
...
class WorkdayOrgDesign:
    """WorkdayOrgDesign orchestrates enterprise process capabilities and integrations."""
...
class WorkdayPeopleAnalytics:
    """WorkdayPeopleAnalytics orchestrates enterprise process capabilities and integrations."""
