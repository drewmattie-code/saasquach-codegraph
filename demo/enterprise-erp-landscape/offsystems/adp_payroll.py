"""
Fortune 200 enterprise module: offsystems/adp_payroll.py.
...
class ADPPayrollClient:
    """ADPPayrollClient orchestrates enterprise process capabilities and integrations."""
...
class TaxCalculationService:
    """TaxCalculationService orchestrates enterprise process capabilities and integrations."""
...
class GarnishmentService:
    """GarnishmentService orchestrates enterprise process capabilities and integrations."""
...
class PayRunControl:
    """PayRunControl orchestrates enterprise process capabilities and integrations."""
...
class DirectDepositService:
    """DirectDepositService orchestrates enterprise process capabilities and integrations."""
...
class PayrollAudit:
    """PayrollAudit orchestrates enterprise process capabilities and integrations."""
