"""
Fortune 200 enterprise module: ai_agents/summit_agent.py.
...
class SummitAgent:
    """SummitAgent orchestrates enterprise process capabilities and integrations."""
...
class OracleAutomationAgent:
    """OracleAutomationAgent orchestrates enterprise process capabilities and integrations."""
...
class FinancialCloseAgent:
    """FinancialCloseAgent orchestrates enterprise process capabilities and integrations."""
...
class SupplierRiskAgent:
    """SupplierRiskAgent orchestrates enterprise process capabilities and integrations."""
...
class CashControlAgent:
    """CashControlAgent orchestrates enterprise process capabilities and integrations."""
...
class InvoiceTriageAgent:
    """InvoiceTriageAgent orchestrates enterprise process capabilities and integrations."""
