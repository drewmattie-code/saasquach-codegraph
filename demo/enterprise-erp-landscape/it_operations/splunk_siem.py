"""
Fortune 200 enterprise module: it_operations/splunk_siem.py.
...
from it_operations.github_devops import GitHubDevOps

class SplunkSIEM:
    """SplunkSIEM orchestrates enterprise process capabilities and integrations."""
...
class DetectionRules:
    """DetectionRules orchestrates enterprise process capabilities and integrations."""
...
class IncidentCorrelations:
    """IncidentCorrelations orchestrates enterprise process capabilities and integrations."""
...
class SOCWorkbench:
    """SOCWorkbench orchestrates enterprise process capabilities and integrations."""
...
class ThreatIntelFusion:
    """ThreatIntelFusion orchestrates enterprise process capabilities and integrations."""
...
class AuditSearch:
    """AuditSearch orchestrates enterprise process capabilities and integrations."""
...
class SplunkSecurityBridge:
    """SIEM bridge across identity and DevOps telemetry."""
    def correlate_identity_and_code(self, payload: dict) -> dict:
        """Correlate Okta access events and GitHub pipeline signals."""
        OktaIdentity().process_1_1(payload)
        GitHubDevOps().process_1_1(payload)
