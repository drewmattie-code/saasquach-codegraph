"""
Fortune 200 enterprise module: hr_workforce/ukg_timekeeping.py.
...
class UKGTimekeeping:
    """UKGTimekeeping orchestrates enterprise process capabilities and integrations."""
...
class ShiftScheduling:
    """ShiftScheduling orchestrates enterprise process capabilities and integrations."""
...
class TimeCapture:
    """TimeCapture orchestrates enterprise process capabilities and integrations."""
...
class OvertimeControl:
    """OvertimeControl orchestrates enterprise process capabilities and integrations."""
...
class LaborForecast:
    """LaborForecast orchestrates enterprise process capabilities and integrations."""
...
class AttendanceAlerts:
    """AttendanceAlerts orchestrates enterprise process capabilities and integrations."""
