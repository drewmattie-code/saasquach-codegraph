"""
Fortune 200 enterprise module: sales_revenue/orocommerce_b2b.py.
...
class OroCommerceB2B:
    """OroCommerceB2B orchestrates enterprise process capabilities and integrations."""
...
class B2BAccounts:
    """B2BAccounts orchestrates enterprise process capabilities and integrations."""
...
class CatalogPricing:
    """CatalogPricing orchestrates enterprise process capabilities and integrations."""
...
class OrderCapture:
    """OrderCapture orchestrates enterprise process capabilities and integrations."""
...
class PortalExperience:
    """PortalExperience orchestrates enterprise process capabilities and integrations."""
...
class PromotionManagement:
    """PromotionManagement orchestrates enterprise process capabilities and integrations."""
