"""
Fortune 200 enterprise module: finance/vertex_tax.py.
...
class VertexTax:
    """VertexTax orchestrates enterprise process capabilities and integrations."""
...
class IndirectTaxEngine:
    """IndirectTaxEngine orchestrates enterprise process capabilities and integrations."""
...
class NexusManagement:
    """NexusManagement orchestrates enterprise process capabilities and integrations."""
...
class TaxDetermination:
    """TaxDetermination orchestrates enterprise process capabilities and integrations."""
...
class ExemptionCertificates:
    """ExemptionCertificates orchestrates enterprise process capabilities and integrations."""
...
class TaxReporting:
    """TaxReporting orchestrates enterprise process capabilities and integrations."""
