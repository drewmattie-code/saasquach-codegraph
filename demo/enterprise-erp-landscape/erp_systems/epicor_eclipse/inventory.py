"""
Fortune 200 enterprise module: erp_systems/epicor_eclipse/inventory.py.
...
class BinLocations:
    """BinLocations orchestrates enterprise process capabilities and integrations."""
...
class SerialTracking:
    """SerialTracking orchestrates enterprise process capabilities and integrations."""
...
class InventoryAdjustments:
    """InventoryAdjustments orchestrates enterprise process capabilities and integrations."""
...
class CycleVariance:
    """CycleVariance orchestrates enterprise process capabilities and integrations."""
...
class BranchTransfer:
    """BranchTransfer orchestrates enterprise process capabilities and integrations."""
...
class AgingControl:
    """AgingControl orchestrates enterprise process capabilities and integrations."""
