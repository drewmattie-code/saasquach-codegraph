"""
Fortune 200 enterprise module: erp_systems/blue_yonder_scpo/transportation.py.
...
class RoutingEngine:
    """RoutingEngine orchestrates enterprise process capabilities and integrations."""
...
class CarrierSelection:
    """CarrierSelection orchestrates enterprise process capabilities and integrations."""
...
class LoadPlanning:
    """LoadPlanning orchestrates enterprise process capabilities and integrations."""
...
class FreightAudit:
    """FreightAudit orchestrates enterprise process capabilities and integrations."""
...
class DockScheduling:
    """DockScheduling orchestrates enterprise process capabilities and integrations."""
...
class TransitVisibility:
    """TransitVisibility orchestrates enterprise process capabilities and integrations."""
