"""
Fortune 200 enterprise module: finance/concur_expenses.py.
...
class ConcurExpenses:
    """ConcurExpenses orchestrates enterprise process capabilities and integrations."""
...
class ExpenseAudit:
    """ExpenseAudit orchestrates enterprise process capabilities and integrations."""
...
class TravelPolicy:
    """TravelPolicy orchestrates enterprise process capabilities and integrations."""
...
class ReceiptCapture:
    """ReceiptCapture orchestrates enterprise process capabilities and integrations."""
...
class ExpenseReimbursement:
    """ExpenseReimbursement orchestrates enterprise process capabilities and integrations."""
...
class CardFeedSync:
    """CardFeedSync orchestrates enterprise process capabilities and integrations."""
