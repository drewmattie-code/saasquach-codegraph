"""
Fortune 200 enterprise module: offsystems/coupa_procurement.py.
...
class CoupaClient:
    """CoupaClient orchestrates enterprise process capabilities and integrations."""
...
class SourcingOperations:
    """SourcingOperations orchestrates enterprise process capabilities and integrations."""
...
class SpendAnalytics:
    """SpendAnalytics orchestrates enterprise process capabilities and integrations."""
...
class ContractLifecycle:
    """ContractLifecycle orchestrates enterprise process capabilities and integrations."""
...
class InvoiceCapture:
    """InvoiceCapture orchestrates enterprise process capabilities and integrations."""
...
class SupplierOnboarding:
    """SupplierOnboarding orchestrates enterprise process capabilities and integrations."""
