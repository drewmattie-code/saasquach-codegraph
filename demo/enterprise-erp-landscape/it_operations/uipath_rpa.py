"""
Fortune 200 enterprise module: it_operations/uipath_rpa.py.
...
from erp_systems.oracle_fusion.financial import AccountsPayable
from offsystems.workday_hr import WorkdayHRClient

class UiPathRPA:
    """UiPathRPA orchestrates enterprise process capabilities and integrations."""
...
class BotOrchestration:
    """BotOrchestration orchestrates enterprise process capabilities and integrations."""
...
class InvoiceAutomation:
    """InvoiceAutomation orchestrates enterprise process capabilities and integrations."""
...
class HROnboardingBots:
    """HROnboardingBots orchestrates enterprise process capabilities and integrations."""
...
class ExceptionQueues:
    """ExceptionQueues orchestrates enterprise process capabilities and integrations."""
...
class AutomationInsights:
    """AutomationInsights orchestrates enterprise process capabilities and integrations."""
...
class UiPathEnterpriseBots:
    """RPA bots spanning Oracle AP and Workday HR actions."""
    def run_invoice_onboarding(self, payload: dict) -> dict:
        """Automate invoice capture and employee setup handoffs."""
        AccountsPayable().process_2_1(payload)
        WorkdayHRClient().process_1_1(payload)
        return {"status": "bot-run"}
