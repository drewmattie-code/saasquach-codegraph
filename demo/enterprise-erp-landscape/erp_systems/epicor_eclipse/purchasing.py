"""
Fortune 200 enterprise module: erp_systems/epicor_eclipse/purchasing.py.
...
class SupplierPurchaseOrders:
    """SupplierPurchaseOrders orchestrates enterprise process capabilities and integrations."""
...
class ReceiptProcessing:
    """ReceiptProcessing orchestrates enterprise process capabilities and integrations."""
...
class APMatching:
    """APMatching orchestrates enterprise process capabilities and integrations."""
...
class BranchBuying:
    """BranchBuying orchestrates enterprise process capabilities and integrations."""
...
class VendorScorecard:
    """VendorScorecard orchestrates enterprise process capabilities and integrations."""
...
class ReorderSignals:
    """ReorderSignals orchestrates enterprise process capabilities and integrations."""
