"""
Fortune 200 enterprise module: offsystems/servicenow_itsm.py.
...
class ServiceNowClient:
    """ServiceNowClient orchestrates enterprise process capabilities and integrations."""
...
class IncidentManagement:
    """IncidentManagement orchestrates enterprise process capabilities and integrations."""
...
class ChangeManagement:
    """ChangeManagement orchestrates enterprise process capabilities and integrations."""
...
class CMDBSync:
    """CMDBSync orchestrates enterprise process capabilities and integrations."""
...
class ProblemManagement:
    """ProblemManagement orchestrates enterprise process capabilities and integrations."""
...
class ReleaseCalendar:
    """ReleaseCalendar orchestrates enterprise process capabilities and integrations."""
